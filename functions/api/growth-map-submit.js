/**
 * Cloudflare Pages Function — Growth Map submission handler.
 *
 * Path: /api/growth-map-submit
 *
 * Receives JSON from introduction-survey.html, calculates scoring,
 * and emails Hunter via Resend.
 *
 ...
 *   FROM_EMAIL      — sender address (defaults to forms@nelvo.ca — must be on a verified Resend domain)
 */
...
export async function onRequestPost(context) {
  ...
  // Raw = sum of 5-25. Normalize to 1.0-9.0: ((raw - 5) / 20) * 8 + 1.
  // Quadrant thresholds at 5.0 on each axis.
